...
public class MauSac_View extends javax.swing.JFrame {
    private MauSac_Service mau = new MauSac_Service();
    private DefaultTableModel model = new DefaultTableModel();
    private int index = -1;
    /**
     * Creates new form MauSac_View
     */
    public MauSac_View() {
        initComponents();
        this.setLocationRelativeTo(null);
        this.fillTable_Mau(mau.getAll_Mau());
    }
         void fillTable_Mau(List<MauSac> list) {
        model = (DefaultTableModel) tbMauSac.getModel();
        model.setColumnCount(0);
        model.setRowCount(0);
        model.addColumn("STT");
        model.addColumn("Mã màu");
        model.addColumn("Tên màu");

        int stt = tbMauSac.getSelectedRow();
        stt = stt + 1;
        for (MauSac cl : list) {
         ...
         MauSac readForm_MS() {
        String maSN = txtmaMau.getText();
        String tenSN = txttenMau.getText();
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtmaMau, javax.swing.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
    ...
    private void tbMauSacMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbMauSacMouseClicked
        // TODO add your handling code here:
                        int indexn = tbMauSac.getSelectedRow();
        String mathuoctinh = (String) tbMauSac.getValueAt(indexn, 1);
        String tenthuoctinh = (String) tbMauSac.getValueAt(indexn, 2);
        txtmaMau.setText(mathuoctinh);
        txttenMau.setText(tenthuoctinh);
    }//GEN-LAST:event_tbMauSacMouseClicked

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
                MauSac spct = this.readForm_MS();
        if (mau.them_Mau(spct) > 0) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        index = tbMauSac.getSelectedRow();
        String ma = tbMauSac.getValueAt(index, 1).toString();
        if (mau.sua_Mau(sp, ma) > 0) {
