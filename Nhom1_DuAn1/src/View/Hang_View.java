...
public class Hang_View extends javax.swing.JFrame {
    ...
    Hang readForm_HG() {
        String maSN = txtmaHang.getText();
        String tenSN = txttenHang.getText();
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtmaHang, javax.swing.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
    ...
    private void tbHangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbHangMouseClicked
        // TODO add your handling code here:
        int indexn = tbHang.getSelectedRow();
        String mathuoctinh = (String) tbHang.getValueAt(indexn, 1);
        String tenthuoctinh = (String) tbHang.getValueAt(indexn, 2);
        txtmaHang.setText(mathuoctinh);
        txttenHang.setText(tenthuoctinh);
    }//GEN-LAST:event_tbHangMouseClicked

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        Hang spct = this.readForm_HG();
        if (hang.them_Hang(spct) > 0) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        index = tbHang.getSelectedRow();
        String ma = tbHang.getValueAt(index, 1).toString();
